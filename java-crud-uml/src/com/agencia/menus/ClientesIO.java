...
public class ClientesIO {
	   ...
	   public static int SubMenuClientes(Scanner scanner) {
	      ...
	      do {
	         ...
	         switch (option) {
	            case 1:
	               ...
	               clientes.setEmailCliente(scanner.nextLine());
	               System.out.println("Senha: ");
	               clientes.setSenhaCliente(scanner.nextLine());
	               System.out.println("Endereço: ");
	               clientes.setEnderecoCliente(scanner.nextLine());
